...
public class PraceneVoznjeDAO {
  ...
  public List<Voznja> dohvatiSveVoznje() {
    String upit = "SELECT * FROM pracenevoznje";
  ...
  public List<Voznja> dohvatiVoznje(long odVremena, long doVremena) {
    String upit = "SELECT * FROM pracenevoznje WHERE vrijeme >= ? AND vrijeme <= ?";
  ...
  public List<Voznja> dohvatiVoznjeVozila(int id) {
    String upit = "SELECT * FROM pracenevoznje WHERE id = ?";
  ...
  public List<Voznja> dohvatiVoznjeVozila(int id, long odVremena, long doVremena) {
    String upit = "SELECT * FROM pracenevoznje WHERE id = ? AND vrijeme >= ? AND vrijeme <= ?";
