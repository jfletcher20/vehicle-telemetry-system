...
<html>
	...
	<body>
		<div class="card">
			...
			<div id="tab-simulacije-content" class="tab">
			...
			<nav id="tab-nav">
				...
				<a class="current-tab tab-nav" id="tab-simulacije" href="${pageContext.servletContext.contextPath}/mvc/simulacije/pocetna">Simulacije</a>
			</nav>
		</div>
	</body>
</html>
